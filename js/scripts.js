...
let c = 3;
let d = 3;
console.log((a<c, c>b) || (b<c,c>c) || (c>c, c==d));
console.log((a<c, c>b) && (b<c, c==c) && (c==c, c==d));

let number3 = 0;
let number4 = "0";
let y = false;
console.log((number3 == number4)==y);
console.log((number3 === number4)===y);

let operator = 'output on display';
let operator1 = undefined;
let operator2 = null;
let operator3 = operator ?? operator1 ?? operator2;
